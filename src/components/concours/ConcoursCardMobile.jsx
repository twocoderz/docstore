...
import { FaArrowRight, FaFilePdf, FaTrophy } from "react-icons/fa";

const ConcoursCardMobile = ({ concour, ecoleName }) => (
  <Link to={`/concours/${concour.$id}`} className="block md:hidden h-full">
    <div className="h-full bg-white rounded-2xl shadow-md transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
      <div className="h-16 bg-gradient-to-br from-orange-500 via-orange-600 to-yellow-600 relative overflow-hidden">
        <div className="absolute inset-0 bg-black/10"></div>
        <div className="absolute bottom-4 left-6 right-6">
          <div className="flex items-center space-x-3">
            <div className="hidden md:block p-2 bg-white/20 backdrop-blur-sm rounded-lg">
